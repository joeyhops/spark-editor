## Spark Editor: Code Editor for Telus Spark Exhibit##
#### Forked from [deprecated p5.js editor](https://github.com/processing/p5.js-editor)

This version of the p5 Editor was updated to build on more recent versions of NodeJS (Specifically v6.17.1) and updated to use a more recent version of NW.JS as well (v0.30.0)

It is set to reload the base project file (SparkBoids) after the computer has been idle (no user input) for 2 minutes. After that time the editor will reload the window and start a new server, opening the new project in Chrome.

## Original p5.js README
...
* [gui.js](https://github.com/nwjs/gui.js/wiki)
